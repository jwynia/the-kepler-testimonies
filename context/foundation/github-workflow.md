...
# Polls (create via web UI or API)
# Polls are created as Discussion posts with poll options
```

### Creating a Poll

Polls are created as GitHub Discussions in the Polls category:

```bash
gh api repos/jwynia/the-kepler-testimonies/discussions \
  -f title="Poll: Your Question" \
  -f body="Options and context" \
  -f categoryId="CATEGORY_ID"
```

Or create via the web UI at: https://github.com/jwynia/the-kepler-testimonies/discussions/new?category=polls
