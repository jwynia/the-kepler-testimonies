...
## State
**Voting Active** - Community polls live on GitHub Discussions for two foundational questions.
...
- **Active polls:**
  - [What is the Kepler?](https://github.com/jwynia/the-kepler-testimonies/discussions/9)
  - [What makes 12 testimonies impossible?](https://github.com/jwynia/the-kepler-testimonies/discussions/8)

## What's Next
1. ~~Post voting options to GitHub Discussions~~ Done
...
## Open Questions
- How to structure 500 testimonies for reading/presentation?
- ~~What is the Kepler?~~ → **Options ready for vote** (Failed Mission, Lifeboat, Stopover)
- ~~What makes 12 testimonies "impossible"?~~ → **Options ready for vote** (Absent Witnesses, Document Anomaly, Agreement Problem)
- Who collected these testimonies and why? (depends on Kepler choice)
